 ...
 $( "#network" ).empty(); 
    ...
    var size =d3.scaleLog().range([1,40]) // escala de la linea


     d3.queue()
        .defer(d3.csv,"https://raw.githubusercontent.com/63anp3ca/HomeWork2/master/datafin.csv",parse)  // llama funcion parse para las columnas
        .await(ready)
        ...
        var linkElements = svg.append("g")
          ...
          .on('mouseover', function(d) {
               ...
               //  tooltip.select('.target').html("<b> Candidato: " + d.source.id  + "</b>");
                 ...
                 tooltip.select('.monto').html("<b> monto: " + d.value  + "</b>");
